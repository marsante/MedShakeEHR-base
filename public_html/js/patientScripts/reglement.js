...
function construireLigneTableauActes(index, value) {
  ...
  if (value['code'] == 'IK' || index == 'IK') {
    tabLigne += '<td class="text-end"' + tabColHide + '><div class="input-group input-group-sm"><span class="input-group-text">x</span><input class="form-control text-end ikNombre" value="' + value['ikNombre'] + '"></div></td>")';
  ...
  tabLigne += '<td></td>';
  // dépassement
  tabLigne += '<td class="text-end"><div class="input-group input-group-sm"><input class="form-control text-end add2DepaSum" value="' + value['depassement'] + '"><span class="input-group-text">€</span></div></td>';
  // code qualif
